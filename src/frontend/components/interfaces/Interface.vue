<template>
    <div class="ct-card ct-card-hover overflow-visible" :class="{ 'opacity-70': !isInterfaceEnabled(iface) }">
        ...
        <div class="flex items-center py-2.5 px-1">
            ...
            <!-- icon -->
            <div class="mx-2 flex size-10 shrink-0 items-center justify-center rounded-lg border text-[#9fcaff]" :class="[ isInterfaceEnabled(iface) && iface._stats?.status === true ? 'border-[rgba(79,168,255,0.4)] bg-[rgba(79,168,255,0.12)] shadow-[0_0_18px_rgba(79,168,255,0.18)]' : 'border-[var(--ct-border)] bg-[rgba(255,255,255,0.04)] text-[var(--ct-dim)]' ]">
